...
class AddressForm extends Component {
    ...
    handleCreateAddress = () => {
        ...
        authAxios
            ...
            .catch(err => { this.setState({ error: err, saving: false }) })
    }
    ...
    render() {
        ...
        return (
            <Form onSubmit={this.handleSubmit} success={success} error={error}>
                ...
                <Form.Button disabled={saving} loading={saving}>Save</Form.Button>
            </Form>
        )
    }
}
                ...
                {addresses && addresses.map(address => {
                    return (
                        <Card fluid key={address.id} >
                            ...
                            <Card.Content extra>
                                <Button basic color='green' onClick={() => this.handleSelectAddress(address)} >Update</Button>
                                <Button basic color='red' onClick={() => this.handleDeleteAddress(address.id)}>Delete</Button>
                            </Card.Content>
                        </Card>
                    )
                })}
