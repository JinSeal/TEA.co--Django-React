...
class ProductList extends Component {
  ...
  handleFetchProducts = () => {
    ...
    axios
      .get(productListURL(activePage, pageSize, searchValue))
      .then(res => {
  ...
  renderBreadcrumb = () => {
    ...
    Label !== "" &&
      list.push({
        key: getValue("Label", Label),
        content: getValue("Label", Label)
      });
    Origin !== "" &&
      list.push({
        key: getValue("Origin", Origin),
        content: getValue("Origin", Origin)
      });
    Category !== "" &&
      list.push({
        key: getValue("Category", Category),
        content: getValue("Category", Category)
      });
              ...
              <Form onSubmit={this.handleFilterSubmit}>
                <Accordion as={Menu} vertical>
                  ...
                  >
                    ...
                    <Form.Button color="olive" onClick={this.handleClickReset}>
                      Reset
                    </Form.Button>
                  </Menu.Item>
                  {filter &&
