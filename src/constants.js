...
export const productListURL = (
  ...
  `${endpoint}/products/?page=${page}&page_size=${size}&search=${searchValue}&category=${category}&origin=${origin}&label=${label}`;
export const productDetailURL = id => `${endpoint}/products/${id}/`;
export const addToCartURL = `${endpoint}/add-to-cart/`;
export const removeOrderItemURL = itemID =>
  `${endpoint}/order-items/${itemID}/delete/`;
...
export const addressUpdateURL = addressID =>
  `${endpoint}/address/${addressID}/update/`;
export const addressDeleteURL = addressID =>
  `${endpoint}/address/${addressID}/delete/`;
